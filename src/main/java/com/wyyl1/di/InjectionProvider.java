...
class InjectionProvider<T> implements ContextConfig.ComponentProvider<T> {
    ...
    private List<Injectable<Field>> getInjectFields(Class<T> component) {
        List<Field> injectFields = InjectionProvider.traverse(component, (fields, current) -> injectable(current.getDeclaredFields()).toList());
